...
with I/O devices and local timer, as if it runs right on top 
...
seamless live migration of VMs with direct I/O device and 
timer access without degrading the migration-induced downtime.
\end{abstract}
