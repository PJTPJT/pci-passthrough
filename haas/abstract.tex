...
with I/O devices and local timer hardware, as if it runs on
a bare-metal physical server. 
This paper describes the design, implementation, and evaluation of 
%a HaaS management system called the \fullname (\sna) 
a \na hypervisor that supports a HaaS VM 
having direct access to I/O devices and local timer hardware
without incurring any I/O performance penalty. The \na hypervisor 
also provides seamless live migration of a HaaS VM
