...
% Our contributions
In this paper, we propose the Baremetal Virtual Machine (BVM) to reduce
key virtualization overheads on HaaS platforms.
BVM enables a traditional system VM to run atop a thin hypervisor 
and achieve near baremetal performance while retaining the 
administrator's flexibility to live migrate the VM.
A key feature of BVM includes
...
We describe a prototype implementation on the KVM/QEMU that leverages 
Intel VT-d hardware support to achieve direct network and timer 
