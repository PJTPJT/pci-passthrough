...
First , it sets the entry's IM bit to 1, which means that any interrupt matching this Interrupt Remapping Table entry is to be delivered via the posted interrupt mechanism.  
