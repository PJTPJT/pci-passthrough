...
\subsection{Achieving Bare-metal I/O Performance in \na}
...
interrupt, {\em even though the timer interrupt is spurious}
because its expiration time is not reached yet.
...
In \na, although the sole VM can directly control the timer hardware on its assigned CPUs, the SVMV hypervisor can still regain 
