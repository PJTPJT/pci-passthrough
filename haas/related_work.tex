...
The absence of a virtualization layer 
...
VMs but also introduce hypervisor-level
emulation overhead of hardware access by guests. To mitigate I/O-related 
...
%TODO: Discuss existing live migration and bare-metal approaches
% pre-copy, post-copy, BLMvisor, and Bitvisor
