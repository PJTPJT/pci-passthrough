...
\figw{cyclictest}{9}{The cumulative distribution function of the timer interrupt latency of the 
Baremetal, VHOST and DTID configuration}
...
\multirow{2}{*}{\bf Baremetal} & \multirow{2}{*}{37.39} & 0 & 118592 & 256 \\ \cline{3-5}
&  & 1 & 0 & 348 \\ \hline
...
by a Baremetal server, an OPTI HaaS VM and a DTID HaaS VM, when thet send out 
TCP traffic over an infiniband link using iperf}
\label{tab:network_interrupts}
\vspace{-0.06in}
\end{table}
