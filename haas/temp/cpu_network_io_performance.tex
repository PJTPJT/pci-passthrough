...
\begin{tabular}[c]{@{}l@{}}BAREMETAL\end{tabular}                                & $37.39 \pm 0.08$ & $37.52 \pm 0.10$ & $12 \pm 3$\\ \hline
...
\end{tabular}
\caption{Comparison of Network Bandwidth and Latency.}
...
\begin{tabular}[c]{@{}l@{}}IN OPTI GUEST\end{tabular}                   & 0.66   & 81.2  & -- \\ \hline
...
utilization in the OPTI and DTID guest. \%USER is the \%CPU
time consumed in the user mode, \%SYSTEM is the \%CPU time
consumed in the kernel mode and \%GUEST is the \%CPU time
