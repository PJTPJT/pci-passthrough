...
\begin{tabular}[c]{@{}l@{}}GUEST\\ + VFIO\\ + OPTIMIZATION\\ + DTID\end{tabular} & $37.35 \pm 0.08$ &  & $12 \pm 5$\\ \hline
\end{tabular}
...
the assigned NIC with CPU optimization. (e) guest with (d) and
DTID.}
...
\begin{tabular}[c]{@{}l@{}}IN GUEST\end{tabular} & 0.66 & 81.2 & -- \\ \hline
\begin{tabular}[c]{@{}l@{}}IN DITD GUEST\end{tabular} & 0.68 & 82.9 & -- \\ \hline
\end{tabular}
...
optimization. (e) guest with (d) and DTID. In (d) and (e), we
measure the CPU utilization.  \%USER is the \%CPU time
consumed in the user mode, \%SYSTEM is the \%CPU time consumed
in the kernel mode and \%GUEST is the \%CPU time consumed by
the guest.}
