...
\diagbox{\textbf{Configuration}}{\textbf{Feature}} & \textbf{Access NIC} & \textbf{NIC Interrupt} & \textbf{HLT Instruction} & \textbf{VMX Preemption Timer} & \textbf{Timer Interrupt} & \textbf{IPI} \\ \hline
%\textbf{Bare-metal} & --                         & --                            & --                        & --                            & --                        & --                        \\ \hline
\textbf{VHOST}      & Yes                        & Yes                           & Yes                       & Yes                           & Yes                       & Yes                       \\ \hline
\textbf{VFIO}       & {\color[HTML]{FE0000} No}  & {\color[HTML]{FE0000} No}     & Yes                       & Yes                           & Yes                       & Yes                       \\ \hline
\textbf{OPTI}       & {\color[HTML]{FE0000} No}  & {\color[HTML]{FE0000} No}     & {\color[HTML]{FE0000} No} & {\color[HTML]{FE0000} No}     & Yes                       & Yes                       \\ \hline
\textbf{DTID}       & {\color[HTML]{FE0000} No}  & {\color[HTML]{FE0000} No}     & {\color[HTML]{FE0000} No} & {\color[HTML]{FE0000} No}     & {\color[HTML]{FE0000} No} & Yes                       \\ \hline
\textbf{DID}        & {\color[HTML]{FE0000} No}  & {\color[HTML]{FE0000} No}     & {\color[HTML]{FE0000} No} & {\color[HTML]{FE0000} No}     & {\color[HTML]{FE0000} No} & {\color[HTML]{FE0000} No} \\ \hline
\end{tabular}%
}
\caption{Comparison of additional features other than the
existing KVM optimizations for each virtualization
configuration.}
...
Table~\ref{tab:configuration} are evaluated. In contrast to
the VHOST configurations, other configurations uses the
passthroughed network card.
