...
We found it necessary to use two CPU cores to
saturate a 40Gbps Infiniband link for all configurations 
(as opposed to just one core for saturating a 1 Gbps link). 
One core handles NIC interrupts and soft IRQs, while the other
runs network performance testing workload. We use a third
core to monitor CPU utilization, which does not
