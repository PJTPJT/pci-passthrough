...
utilization of host was $68.32/200$. \emph{Guest User} is
$0.23/200$. Thus, the total CPU utilization due to the work
done by the VM was the sum of \emph{Guest User}, \emph{Guest
...
instruction, it used a busy waiting loop. The CPU cycles
burned by the busy waiting loops bumped up the host CPU
utilization in \emph{Host System} and consequently the total
CPU utilization.
...
suggests that \na was successful in enabling a Haas Server to
