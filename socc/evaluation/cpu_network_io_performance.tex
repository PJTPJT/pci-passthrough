...
\multirow{2}{*}{}   & \multicolumn{2}{c|}{\textbf{Host}}  & \multicolumn{2}{c|}{\textbf{Guest}} & \multirow{2}{*}{\textbf{Total CPU\%}} & \multirow{2}{*}{\textbf{No. CPUs}} & \multicolumn{3}{c|}{\textbf{Network}}                                                                                                                                                                    \\ \cline{2-5} \cline{8-10} 
                    & \textbf{User\%} & \textbf{System\%} & \textbf{User\%} & \textbf{System\%} &                                       &                                    & \textbf{\begin{tabular}[c]{@{}c@{}}Outbound\\ (Gbps)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Inbound\\ (Gbps)\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Round-Trip Delay\\ ($\boldsymbol{\mu}$s)\end{tabular}} \\ \hline
...
%and thus the total CPU utilization.
