...
a \sna prototype that supports a HaaS VM with dedicated 
CPU and memory resources, direct access to local APIC timer and 
PCIe device hardware, direct delivery of all interrupts (timers,
inter-VCPU IPIs, and I/O devices), close to bare-metal performance,
