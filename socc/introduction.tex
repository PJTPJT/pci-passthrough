...
without hypervisor's intervention, 
...
%
To summarize, the functional requirements of SVMvisor are as follows.
\begin{itemize} 
%\setlength\itemsep{-0.04in}
\parskip 0mm
\itemsep 0mm
\item Direct passthrough of all PCIe devices without involving the hypervisor,
\item Direct delivery of interrupts, including PCIe device interrupts, local timer interrupts, and inter-processor interrupts (IPI), 
\item Seamless migration of virtual machine and physical device state, and 
\item Minimal hypervisor footprint limited to one CPU core and around 100MB of RAM.
\end{itemize}
...
Finally, we discuss related work and conclusions.
