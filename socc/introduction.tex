...
are directly deivered to a HaaS VM without hypervisor intervention.
...
%\vspace{-0.1in}
%The rest of this paper describes the necessary background, followed
%by the design, implementation, and evaluation of \sna's support 
%for HaaS VMs.
%The rest of this paper is organized as follows.
%We first provide background on hardware support for 
%pass-through I/O and posted interrupts.
%Next we describe the design and implementation of \sna,
