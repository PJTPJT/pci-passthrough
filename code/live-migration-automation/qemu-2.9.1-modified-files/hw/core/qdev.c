...
void osnet_device_set_realized_top_half(Object *obj, bool value, Error **errp){
...
void osnet_device_set_realized_bottom_half(Object *obj, bool value, Error **errp) {
    //printf("%s\n",__func__);
    DeviceState *dev = DEVICE(obj);
    DeviceClass *dc = DEVICE_GET_CLASS(dev);
    HotplugHandler *hotplug_ctrl = qdev_get_hotplug_handler(dev);
...
void osnet_device_reset(DeviceState *dev)
{
	device_reset(dev);
...
static void device_initfn(Object *obj)
{
    ...
    //printf("before realized %s\n",__func__);
    object_property_add_bool(obj, "realized",
                             device_get_realized, device_set_realized, NULL);
    //printf("after realized %s\n",__func__);
