...
ETEXI
    ...
    {
        .name       = "osnet-vfio-nic-create",
        .args_type  = "device:O",
        .params     = "driver[,prop=value][,...]",
        .help       = "prepare device, taking -device on the command line",
        .cmd        = hmp_osnet_vfio_nic_create,
    },

STEXI
@item osnet-vfio-nic-add
@findex osnet-vfio-nic-add
OSNET creates and prepares the software VFIO device.
ETEXI

    {
        .name       = "osnet-vfio-nic-realize-top-half",
        .args_type  = "id:s",
        .params     = "device",
        .help       = "Realize the top-half software VFIO NIC",
        .cmd        = hmp_osnet_vfio_nic_realize_top_half,
    },

STEXI
@item osnet-vfio-nic-realize-top-half
@findex osnet-vfio-nic-realize-top-half
OSNET realizes the top-half software VFIO NIC.
ETEXI

    {
        .name       = "osnet-vfio-nic-realize-bottom-half",
        .args_type  = "id:s",
        .params     = "device",
        .help       = "Realize the bottom-half software VFIO NIC",
        .cmd        = hmp_osnet_vfio_nic_realize_bottom_half,
    },

STEXI
@item osnet-vfio-nic-realize-bottom-half
@findex osnet-vfio-nic-realize-bottom-half
OSNET realizes bottom-half the software VFIO NIC.
ETEXI


    {
        .name       = "osnet-vfio-nic-reset",
        .args_type  = "id:s",
        .params     = "device",
        .help       = "Reset the VFIO NIC",
        .cmd        = hmp_osnet_vfio_nic_reset,
    },

STEXI
@item osnet-vfio-nic-reset
@findex osnet-vfio-nic-reset
OSNET resets the VFIO NIC.
ETEXI
